...
-> To run the source code
    Command To compile the source code : g++ 190101003_Assign2_assembler.cpp
    Command to execute : ./a.out

Linker-Loader
-> linker_input.txt is attached and is input to our source code (180101055_Assign2_linker_loader.cpp)
-> on running source code will generate three files esTableFile.txt and Output_LinkerFile.txt which are ES Table file and memory table file respectively
-> To run the source code
